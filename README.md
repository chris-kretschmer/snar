...
- **Statistik pro Link** – Gesamtklicks, Klicks-Diagramm mit fünf umschaltbaren Zeiträumen (Tag/Woche/Monat/Jahr/Gesamt), Referrer (nur Hostname), Gerätetyp, Browser, Sprache, letzte 25 Klicks. Bewusst datensparsam: keine IP-Speicherung, kein Fingerprinting.
